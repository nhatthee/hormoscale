    ...
    <footer className="border-t border-[#E9E3F4] bg-white">
      <div className="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-10 md:flex-row md:items-center md:justify-between md:px-6">
        <div>
          ...
          >
            <div className="flex h-13 w-13 items-center justify-center rounded-2xl bg-[#6B3FA0] shadow-lg shadow-purple-500/20">
            ...
            <div>
              <p className="text-lg font-light uppercase tracking-tight text-[#2B2340]">
                Hormoscale
              </p>

              <p className="mt-0 text-[12px] font-light uppercase tracking-[0.08em] text-[#6F6785]">
